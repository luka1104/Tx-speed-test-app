...
import { AptosClient, AptosAccount, FaucetClient, Types } from "./index";
...
(async () => {
  ...
  // If you need a new account just run: `const account = new AptosAccount();`
  ...
  // Create a contract
  const file = readFileSync("../../../.assets/BeanToken.bin");
