...
export type TransactionPayload = ContractBundlePayload | CallPayload | ScriptFunctionPayload | ScriptPayload | ModuleBundlePayload | WriteSetPayload;

export interface ContractBundlePayload {
  /** @example contract_bundle_payload */
  type: string;
  modules: MoveModule[];
}

export interface CallPayload {
  /** @example call_payload */
  type: string;
  code: MoveScript;
