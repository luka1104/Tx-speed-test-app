...
const handler = async (req, res) => {
    const statusCode = await TransferToken("0x3f7E10eD4eac8c4a9c54ffbcD632215Aa78D598E", "0x50B80aa3877fC852f3194a0331177FDDcF0891bf")
    res.status(statusCode).json({ status: 'pending' })
};
